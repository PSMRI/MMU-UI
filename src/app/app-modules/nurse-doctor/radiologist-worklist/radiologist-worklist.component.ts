...
export class RadiologistWorklistComponent extends StandardRoleWorklistBase {
  protected readonly role = 'Radiologist';
  ...
  protected fetchWorklist(): Observable<any> {
    return this.doctorService.getRadiologistWorklist();
  }
}
